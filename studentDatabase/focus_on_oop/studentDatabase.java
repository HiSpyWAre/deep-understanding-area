// focus on OOP, there are menu to show statistics; the highest, lowest, and average GPA, file handling in txt file
...
public class studentDatabase {
    public static void main(String[] args) {
        ...
        Connection conn = DriverManager.getConnection(
            "jdbc:mysql://localhost:3306/studentdb", "root", "onw@rdINtech"
        );
